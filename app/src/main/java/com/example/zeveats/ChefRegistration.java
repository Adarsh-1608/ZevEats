...
public class ChefRegistration extends AppCompatActivity {
    ...
    TextInputLayout Fname,Lname,Email,Pass,cpass,mobileno,houseno,area,pincode,Statespin,Cityspin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Statespin = (TextInputLayout) findViewById(R.id.Statee);
        Cityspin = (TextInputLayout) findViewById(R.id.City);
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                statee=Statespin.getEditText().getText().toString().trim();
                cityy=Cityspin.getEditText().getText().toString().trim();
    ...
    public boolean isValid(){
        ...
        boolean isValid=false,isValidhouseno=false,isValidlname=false,isValidname=false,isValidemail=false,isValidpassword=false,isValidconfpassword=false,isValidmobilenum=false,isValidarea=false,isValidpincode=false, isValidstate=false, isValidcity=false;
        ...
        if(TextUtils.isEmpty(statee)){
            Statespin.setErrorEnabled(true);
            Statespin.setError("Fields Can't Be Empty");
        }else{
            isValidstate = true;
        }
        if(TextUtils.isEmpty(cityy)){
            Cityspin.setErrorEnabled(true);
            Cityspin.setError("Fields Can't Be Empty");
        }else{
            isValidcity = true;
        }

        isValid = (isValidarea && isValidconfpassword && isValidpassword && isValidpincode && isValidemail && isValidmobilenum && isValidname && isValidhouseno && isValidlname && isValidstate && isValidcity) ? true : false;
        return isValid;
