...
import com.example.zeveats.ReusableCodeForAll;
import com.example.zeveats.SendNotification.APIService;
import com.example.zeveats.SendNotification.Client;
import com.example.zeveats.SendNotification.Data;
import com.example.zeveats.SendNotification.MyResponse;
import com.example.zeveats.SendNotification.NotificationSender;
                                                ...
                                                group.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
                                                    ...
                                                    public void onCheckedChanged(RadioGroup group, int checkedId) {
                                                        if (home.isChecked()) {
                                                            ...
                                                            localaddress.setText(customer.getLocalAddress() + ", " + customer.getLocalAddress());
