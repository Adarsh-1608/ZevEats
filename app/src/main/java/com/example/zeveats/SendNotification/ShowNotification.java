...
import com.example.zeveats.DeliveryFoodPanel_BottomNavigation;
import com.example.zeveats.MainActivity;
import com.example.zeveats.R;
import com.example.zeveats.chefFoodPanel.ChefPreparedOrderView;
import com.example.zeveats.customerFoodPanel.PayableOrders;
...
public class ShowNotification {
    ...
    public static void ShowNotif(Context context, String title, String message, String page) {
        ...
        PendingIntent pendingIntent = PendingIntent.getActivity(context, 0, acIntent, PendingIntent.FLAG_IMMUTABLE);
        if (page.trim().equalsIgnoreCase("Order")) {
            ...
            pendingIntent = PendingIntent.getActivity(context, 0, acIntent, PendingIntent.FLAG_IMMUTABLE);
        }
